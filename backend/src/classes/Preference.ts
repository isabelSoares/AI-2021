export class Preference {
    ...
    constructor(name: string, paths_propertyValues: string[], paths_schedules: string[], path_user: string) {
        this.name = name;
...
export function load_preference(data : FirebaseFirestore.DocumentData) : Preference {
    ...
    let new_preference = new Preference(name, paths_to_propertyValues, paths_to_schedules, path_to_user);
